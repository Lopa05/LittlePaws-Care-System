 ...
 * @author Maryam Tariq
 */
public class CatStore extends javax.swing.JFrame {
    ...
    public void fillMenu()
    {
        try
        {
            ...
            rs=st.executeQuery("SELECT Count(*) FROM Pet WHERE Pet_Type = 'Cat'");
            rs.next();
            ...
            rs=st.executeQuery("SELECT * FROM Pet WHERE Pet_Type = 'Cat'");
            rs.next();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatStore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
